...
void CollisionSystem::onCollision(World& world, Entity entityA, Entity entityB, const BulletPhysics::builtin::collision::Manifold& manifold)
{
    ...
    if (colliderA->collider->getShape() == BulletPhysics::builtin::collision::CollisionShape::Ground)
    {
        groundEntity = entityA;
        projectileEntity = entityB;
    }
    else if (colliderB->collider->getShape() == BulletPhysics::builtin::collision::CollisionShape::Ground)
    {
